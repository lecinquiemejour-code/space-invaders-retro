...
| 5 | **F5 :** Afficher et déplacer la grille d'aliens | en cours | Une grille de 5 rangées de 11 aliens colorés s'affiche en haut. Elle se déplace horizontalement pas à pas de façon saccadée, descend d'un cran en bordure et change de sens. | — |
